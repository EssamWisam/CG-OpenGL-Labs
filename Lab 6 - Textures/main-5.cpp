...
int main(int, char**) {
    ...
    //* 1 - Generate the sampler and use it to set texture parameters
    GLuint sampler;
    glGenSamplers(1, &sampler);
    glSamplerParameteri(sampler, GL_TEXTURE_MAG_FILTER, GL_NEAREST);        // default is linear
    glSamplerParameteri(sampler, GL_TEXTURE_MIN_FILTER, GL_NEAREST);        // default nearest anyway.
    ...
    while(!glfwWindowShouldClose(window)){
        ...
        //* 2 - Bind the sampler to the texture unit
