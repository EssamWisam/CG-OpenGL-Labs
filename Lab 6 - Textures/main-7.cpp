...
int main(int, char**) {
    ...
    Vertex vertices[] = {
        ...
        { 0.5f, -0.5f, 0.0f, 255,   0, 255, 255, 100, 0},
        { 0.5f,  0.5f, 0.0f, 255, 255,   0, 255, 100, 100},
        {-0.5f,  0.5f, 0.0f, 255,   0,   0, 255, 0, 100}
    };
    ...
    glSamplerParameteri(sampler, GL_TEXTURE_MIN_FILTER, GL_NEAREST);//_MIPMAP_LINEAR);      //<----- uncomment me      
    // This causes it to choose the two mipmaps that most closely match the size of the pixel being textured 
    // and use the GL_NEAREST criterion to get two values then do weighted average.
    // In the tutorial this was confused with GL_NEAREST_MIPMAP_NEAREST (which considers one mipmap only)
