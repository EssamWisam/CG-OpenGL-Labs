...
int main(int, char**) {
    ...
    GLuint fs = loadShader("assets/shaders/simple6.frag", GL_FRAGMENT_SHADER);
    ...
    while(!glfwWindowShouldClose(window)){
      ...
      // Each time we change the active texture and bind the sampler to it after binding the texture.
