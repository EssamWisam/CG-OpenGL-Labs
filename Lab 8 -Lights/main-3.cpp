...
void drawMonkey(int W, int H, GLint mvpLoc, Mesh mesh){
        ...
        mat4 MVP = projection * view * yawPitchRoll(0.0f, angle, 0.0f);
        // Instead of the shift (which did nothing)
        // yaw = rotate about z, pitch = rotate about x and roll = rotate about y
