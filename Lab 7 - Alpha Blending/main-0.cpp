...
int main(int, char**) {
    ...
    GLFWwindow* window = glfwCreateWindow(800, 600, "Recursive Happiness with Transperancy Coming", nullptr, nullptr);
    int W, H;
    ...
    //* 2 - Bring back alpha channel
    Color w = {255, 255, 255, 255 };            //! <--- Try changing the alpha channel to 128 or 0                     
    ...
    //* 2 - Bring back alpha channel (GL_RGBA)
    ...
    while(!glfwWindowShouldClose(window)){
        ...
        glClearColor(0.9f, 0.4f, 0.6f, 1.0f);       // changed to pink
        glClearDepth(1.0);
